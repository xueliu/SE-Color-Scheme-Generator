...
public class ColorGenerationHandler extends EpsilonStandalone {
	private String xmlFilePath;
	private String xmlFileFolder;
	
	public ColorGenerationHandler(String xmlFilePath, String xmlFileFolder){
	...
	public String getSource() throws Exception {
		return "/egl/ColorGeneration.egl";
	}
